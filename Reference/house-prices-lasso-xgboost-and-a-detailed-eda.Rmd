...
```{r}
train <- read.csv("C:/Users/jy990/OneDrive/바탕 화면/뇌/2022/2022/R/kaggle/House prices(LASSO, XGBoost, EDA)/train.csv", stringsAsFactors = F)
test <- read.csv("C:/Users/jy990/OneDrive/바탕 화면/뇌/2022/2022/R/kaggle/House prices(LASSO, XGBoost, EDA)/test.csv", stringsAsFactors = F)
```
